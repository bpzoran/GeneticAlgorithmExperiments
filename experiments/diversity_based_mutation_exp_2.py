...
def diversity_based_mutation_exp_2():
    """
    The diversity_based_mutation_exp_2 function orchestrates a series of optimization experiments using genetic algorithms (GAs)
...
if __name__ == "__main__":
    diversity_based_mutation_exp_2()
